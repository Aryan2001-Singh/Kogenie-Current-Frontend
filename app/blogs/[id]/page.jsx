      ...
      <div className="min-h-screen bg-[#4a5abb] flex flex-col">
        ...
        className="container mx-auto my-10 p-6  bg-#8693e3 rounded-xl shadow-lg max-w-[900px] mt-95">
          ...
          <div className="text-center my-10 mt-100">
            <h1 style={{ color: "#08090a" }} className="text-3xl sm:text-5xl font-bold text-gray-800 max-w-[700px] mx-auto mt-100 mb-6">
              {data.title}
            </h1>
            <div className="flex items-center justify-center mt-15">
              <Image
                ...
                alt="Author"
              />
              <p style={{ color: "gray" }} className="mx-2 ml-3 text-md text-gray-600 font-medium ">
                Aayushi Shrivastava</p>
            </div>
          </div>
          ...
          <div className="mt-4 bg-white rounded-lg p-8">
            <Image
              ...
              alt="Blog Image"
            />
            <p className=" mt-8 mx-5 my-5 text-gray-600 text-center text-lg font-medium max-w-xl">KOgenie makes your ad in just 5 minutes so you can launch
              ad campaigns swiftly, helping you get more people to buy
              your product/service faster.</p>
            <div
