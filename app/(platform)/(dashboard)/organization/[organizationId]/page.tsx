...
const advertisementFacts = [
  ...
  "Over 80% of people recall a video ad they watched in the past 30 days.",
  "Mobile advertising makes up more than 70% of digital ad spend.",
  "Interactive ads generate 3x more engagement than static ads.",
  "Personalized ads lead to a 20% increase in sales on average.",
  "90% of consumers say ads influence their purchase decisions.",
  "Short-form videos have a 60% higher completion rate.",
  "Retargeted ads convert 10x more than cold ads.",
  "Brands using Instagram Stories ads saw a 73% higher conversion rate.",
  "Color increases brand recognition by up to 80%.",
  "The average person is exposed to over 6,000 ads per day.",
  "Native ads outperform traditional banner ads by 53%.",
  "Ad fatigue can reduce ROI by 40%—fresh creatives matter.",
  "Social proof (like reviews in ads) boosts trust by 91%.",
  "Carousel ads drive 72% more clicks than single-image ads.",
  "People are 2x more likely to share video ads than text ads.",
  "The first 3 seconds of a video ad determine 80% of engagement.",
  "Facebook's ad reach exceeded 2.9 billion users in 2023.",
  "Users spend an average of 2.5 hours on social media daily.",
