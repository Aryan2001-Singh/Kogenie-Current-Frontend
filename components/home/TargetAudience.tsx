...
const TargetAudienceCarousel = () => {
  ...
  return (
    <section className="w-full bg-[#fefefe] py-24 px-6 sm:px-12 lg:px-20 font-['Poppins'] text-center relative overflow-hidden">
     ...
     <Link href="/blogs">
        <button className="mt-6 px-8 py-3 rounded-xl text-lg font-semibold text-white bg-gradient-to-r from-[#546aec] to-[#7b8df6] shadow-md hover:scale-100 hover:shadow-xl hover:from-[#3f4ed4] hover:to-[#6c7eea] transition duration-300">
        Explore our blogs
        </button> </Link>
      </div>
    </section>
