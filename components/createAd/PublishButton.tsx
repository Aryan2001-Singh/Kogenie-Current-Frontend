...
onClick={() => {
  if (showConfirm) {
    ...
    setTimeout(() => setHighlightConfirmButton(false), 300); // highlight for 300ms
  } else {
...
>
  ...
  className={`flex-1 min-w-[120px] px-4 py-2 text-white rounded-lg font-medium
              bg-gradient-to-r from-pink-500 to-purple-500 transition duration-200
...
>
  ...
  <button
    ...
    disabled={isPublishing}
    className="flex-1 min-w-[100px] px-4 py-2 bg-gray-100 text-gray-700 rounded-lg font-medium
               hover:bg-gray-200 disabled:opacity-50 transition duration-200"
  >
    Cancel
  </button>
</div>
