...
>
  ...
  <Link
    href="/sign-in"
     className="px-4 py-1 bg-white text-indigo-600 rounded-md font-semibold text-[#546aec] 
     border-2 border-indigo-600 hover:bg-indigo-700 transition"
  >
    Login
  </Link>
  ...
  className="px-4 py-1 rounded-md font-semibold text-white
   bg-gradient-to-r from-[#546aec] to-[#7b8df6] backdrop-blur-md shadow-md transition 
   duration-300 hover:scale-100 hover:shadow-xl hover:from-[#3f4ed4] hover:to-[#6c7eea]"
  >
    Signup
  </Link>
</div>
